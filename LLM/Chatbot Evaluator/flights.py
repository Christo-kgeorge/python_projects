...
def flights_prompt(input_json, metrics):
    Scenario = """
    You are an evaluator agent responsible for assessing and rating customer support conversations based on flights domain. Your task is to evaluate the conversations and rate them on a scale from 0 to 10, providing reasons for your ratings.
    """
    Goal = """
